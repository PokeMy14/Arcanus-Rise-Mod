...
public class TungsteningotItem extends ArcanumrDModElements.ModElement {
	@ObjectHolder("arcanumr_d:tungsteningot")
	public static final Item block = null;
	public TungsteningotItem(ArcanumrDModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("You're starting strong!"));
		}
	}
}
