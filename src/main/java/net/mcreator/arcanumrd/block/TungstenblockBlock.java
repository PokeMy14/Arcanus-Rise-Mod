...
public class TungstenblockBlock extends ArcanumrDModElements.ModElement {
	@ObjectHolder("arcanumr_d:tungstenblock")
	public static final Block block = null;
	public TungstenblockBlock(ArcanumrDModElements instance) {
		super(instance, 3);
	}
