...
import net.mcreator.arcanumrd.item.RubyItem;
...
public class RubyoreBlock extends ArcanumrDModElements.ModElement {
	@ObjectHolder("arcanumr_d:rubyore")
	public static final Block block = null;
	public RubyoreBlock(ArcanumrDModElements instance) {
		super(instance, 2);
	}
